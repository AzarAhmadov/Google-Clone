    ...
    return (
        <header className='sticky top-0 bg-white'>
            <div className='flex-row md:flex w-full  md:p-6 p-3 items-center justify-between'>
                ...
                <button className='md:relative md:top-0 md:right-0 absolute top-[20px] right-[10px] bg-blue-500 text-white md:px-6 md:py-2 py-1 px-4 font-medium text-[13px] lg:text-[17px] rounded-md hover:brightness-105 hover:shadow-md transition-shadow ml-2'>
                    Sign in
                </button>
            </div>
            <SearchHeaderOptions />
